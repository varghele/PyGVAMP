#!/bin/bash
# ===========================================================================
# PyGVAMP — Paper Runs: Standard (VAMP-2)  |  SLURM Array Job
# ===========================================================================
...
#   sbatch --array=0-49 paper_runs_standard.sh
#
#   # Limit concurrency (e.g., max 5 GPU jobs at once)
#   sbatch --array=0-49%5 paper_runs_standard.sh
# ===========================================================================

# ---- SLURM directives -----------------------------------------------------
#SBATCH --job-name=pygv_paper_std
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=logs/paper_std_%A_%a.out
#SBATCH --error=logs/paper_std_%A_%a.err
...
RUN_DIR=$(printf "%s/%s/lag%sns/run_%02d" "${OUTPUT_BASE}" "${PROTEIN_NAME}" "${LAG}" "${RUN_IDX}")
...
# ---- Print job info --------------------------------------------------------
echo "============================================================"
echo "PyGVAMP Paper Run — Standard (VAMP-2)"
echo "============================================================"
